...
NgImageSliderService.ɵfac = function NgImageSliderService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgImageSliderService)();
};
...
SliderCustomImageComponent.ɵfac = function SliderCustomImageComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SliderCustomImageComponent)(ɵɵdirectiveInject(NgImageSliderService), ɵɵdirectiveInject(DomSanitizer), ɵɵdirectiveInject(DOCUMENT));
};
...
SliderLightboxComponent.ɵfac = function SliderLightboxComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SliderLightboxComponent)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(DomSanitizer), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(DOCUMENT));
};
...
NgImageSliderComponent.ɵfac = function NgImageSliderComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgImageSliderComponent)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(PLATFORM_ID), ɵɵdirectiveInject(NgImageSliderService), ɵɵdirectiveInject(ElementRef));
};
...
NgImageSliderModule.ɵfac = function NgImageSliderModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgImageSliderModule)();
};
