...
namespace MagicstoreAPI.Controllers
{
	public class PermissionsController: Controller
	{
        ...
        {
            var result = _permissionsService.GetSinglePermission(id).Result;
            return (result);
        ...
        [HttpPost]
        public async Task<string> CreatePermission(Permissions permission)
        {
        ...
        [HttpPut]
        public async Task<string> UpdatePermission(Permissions permission)
        {
