        ...
        namespace MagicStoreAPIUnitTest.ServicesTest
        {
            ...
            public string _mockEexceptionMessage;
                ...
                public async void UserService_CreateNewUserService_Success()
                {
                    ...
                    //act
                    var testResult = await _iUsersService.CreateNewUserService(_mockUserDTO);
                    //assert
                ...
                public async void UserService_CreateNewUserService_ThrowsEx()
                {
                    ...
                    //act
                    var testResult = await Assert.ThrowsAnyAsync<Exception>(() => _iUsersService.CreateNewUserService(_mockUserDTO));
                    //assert
                ...
                public async void UserService_UpdateUserService_Success()
                {
                    ...
                    //act
                    var result = await _iUsersService.UpdateUserService(_mockUserDTO);
                    //assert
                    Assert.True(result);
                }
                [Fact]
                public async void UserService_UpdateUserService_ThrowsException()
                {
                    ...
                    //act
                    var testResult = await Assert.ThrowsAnyAsync<Exception>(() => _iUsersService.UpdateUserService(_mockUserDTO));
                    //assert
                    Assert.Equal(_mockEexceptionMessage,testResult.Message);
                }
